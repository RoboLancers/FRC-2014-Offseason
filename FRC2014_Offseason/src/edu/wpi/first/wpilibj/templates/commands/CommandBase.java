...
public abstract class CommandBase extends Command {
    ...
    public static OI oi;
    public static PIDDriveTrain driveTrain = new PIDDriveTrain();
    public static RobotCompressor robotCompressor = new RobotCompressor();
    public static FrontRoller frontRoller = new FrontRoller();
    public static RearRoller rearRoller = new RearRoller();
